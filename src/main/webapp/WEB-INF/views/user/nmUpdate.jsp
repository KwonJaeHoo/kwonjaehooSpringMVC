...
<div class="container">
  ...
  <form  action="" method="post">
    ...
    <div class="input__block">
       	<input type="text" placeholder="닉네임" class="input" id="nmNickname" name="nmNickname" value="${spNmUser.nmNickname}" />
		<div class="ws_input">
    ...
    <div class="input__block">
       	<input type="text" placeholder="이메일" class="input" id="nmEmail" name="nmEmail" value="${spNmUser.nmEmail}"/>
       	<div class="ws_input">
			<small> 이메일은 형식에 맞게 입력해주세요. ex) withSports@example.com</small>
		</div>
    </div>
	<div class="input__block">
       	<input type="text" placeholder="전화번호" class="input" id="nmTel" name="nmTel" value="${spNmUser.nmTel}"/>
       	<div class="ws_input">
