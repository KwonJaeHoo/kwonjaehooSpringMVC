          ...
          <form id="promWriteForm" name="promWriteForm" method="post" role="form" class="php-email-form">
            <table width="100%">
              ...
              <tr>
                ...
                <td>
                  <div class="form-group">
                    <input type="date" class="form-control" name="promWriteMoEdate" id="promWriteMoEdate" />
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td >
                  <div class="form-group">
                    <input type="date" class="form-control" name="promWriteCoSdate" id="promWriteCoSdate" />
                  </div>
                </td>
                <td width="10%">
                  <div class="form-group" style="text-align: center;">
                ...
                <td>
                  <div class="form-group">
                    <input type="date" class="form-control" name="promWriteCoEdate" id="promWriteCoEdate" />
                  </div>
                </td>
              </tr>
              <tr>
