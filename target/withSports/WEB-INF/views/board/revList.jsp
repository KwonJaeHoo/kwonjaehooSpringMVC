			...
			<div class="aside-block">
              <ul class="nav nav-pills custom-tab-nav mb-4" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                  ...
                  <button onclick="revSortPaging(1)" class="nav-link active" id="pills-popular-tab" data-bs-toggle="pill" type="button" role="tab" aria-selected="true">최신순</button>
                </li>
                <li class="nav-item" role="presentation">
                  <button onclick="revSortPaging(2)" class="nav-link" id="pills-trending-tab" data-bs-toggle="pill" type="button" role="tab" aria-selected="false">조회수순</button>
                </li>
               </ul>
              </div>
