            	...
            	<table class="table table-ws w-75 p-3">
                	<thead class="mb-5">
                    	<tr>
                            ...
                            <th scope="col" class="text-center" style="width:30%">대회명</th>
			...
			<c:when test="${!empty spLikeList}">
				<c:forEach var="spLikeList" items="${spLikeList}" varStatus="status">
                        <tr class="justify-content-center">
                            ...
                            <td class="ps-5"><a href="javascript:void(0)" onclick="promListView(${spLikeList.promSeq})">${spLikeList.promTitle}</a></td>
